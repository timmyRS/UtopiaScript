...
class Utopia
{
	...
	function __construct($input_stream = null, $output = "echo")
	{
		...
		$this->statements = [// Conditional
			...
			'out' => PrintStatement::class,
			'echo' => PrintStatement::class,
			'write' => PrintStatement::class,
			'output' => PrintStatement::class,
			'print_line' => PrintLineStatement::class,
			'printline' => PrintLineStatement::class,
			'println' => PrintLineStatement::class,
			'printnl' => PrintLineStatement::class,
			'say_line' => PrintLineStatement::class,
			'sayline' => PrintLineStatement::class,
			'sayln' => PrintLineStatement::class,
			'saynl' => PrintLineStatement::class,
			'out_line' => PrintLineStatement::class,
			'outline' => PrintLineStatement::class,
			'outln' => PrintLineStatement::class,
			'outnl' => PrintLineStatement::class,
			'echo_line' => PrintLineStatement::class,
			'echoline' => PrintLineStatement::class,
			'echoln' => PrintLineStatement::class,
			'echonl' => PrintLineStatement::class,
			'write_line' => PrintLineStatement::class,
			'writeline' => PrintLineStatement::class,
			'writeln' => PrintLineStatement::class,
			'writenl' => PrintLineStatement::class,
			'output_line' => PrintLineStatement::class,
			'outputline' => PrintLineStatement::class,
			'outputln' => PrintLineStatement::class,
			'outputnl' => PrintLineStatement::class,
			'read' => ReadStatement::class,
			'in' => ReadStatement::class,
			'input' => ReadStatement::class,
			// Time
